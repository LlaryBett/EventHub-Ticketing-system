      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-6 relative animate-fade-in">
        ...
        <div className="text-center">
          ...
          <div className="text-left bg-blue-50 rounded-lg p-4 mb-6 border-l-4 border-blue-500">
            <h4 className="font-semibold text-blue-900 mb-2 text-sm">Account Benefits:</h4>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8">
                  ...
                  <div className="space-y-2 pt-4 border-t border-gray-200">
                    ...
                    {orderData.totals?.tax > 0 && (
                      <div className="flex justify-between text-xs">
                        ...
                        <span className="text-gray-900 font-medium">{formatPrice(orderData.totals.tax)}</span>
                      </div>
                    )}
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                  <h4 className="font-semibold text-gray-900 text-sm mb-2">Tickets sent to:</h4>
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600">Ticket confirmation has been sent</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900 text-sm">Save your tickets</p>
                      <p className="text-xs text-gray-600">Download or add to your mobile wallet</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900 text-sm">Event day</p>
                      <p className="text-xs text-gray-600">Present QR code at entrance</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {orderData.isGuestOrder && !user && !orderData?.hasAccount && (
                <div className="bg-blue-500 rounded-xl p-6 text-white">
                  <h3 className="text-base font-bold mb-2">Unlock More Benefits!</h3>
              ...
              {orderData.isGuestOrder && !user && orderData?.hasAccount && (
                <div className="bg-green-500 rounded-xl p-6 text-white">
                  <h3 className="text-base font-bold mb-2">Welcome Back!</h3>
