    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          {/* H1 - Mobile: 22-26px, Desktop: larger */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <div key={index} className="relative bg-gradient-to-br from-white via-blue-50 to-purple-50 rounded-2xl shadow-lg p-6 md:p-8 text-center group hover:scale-105 hover:shadow-2xl transition-all duration-500 border border-blue-100/50 overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="text-4xl md:text-5xl mb-4 md:mb-6 group-hover:scale-125 group-hover:rotate-12 transition-all duration-300 drop-shadow-lg">
                  {feature.icon}
                </div>
                ...
                {/* Body text - Mobile: 14px, Desktop: 16px with proper line height */}
        ...
        <div className="text-center mt-16">
          <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 max-w-4xl mx-auto">
            ...
            <div className="flex flex-row gap-3 justify-center">
              {/* Button text - Mobile: 16px minimum for accessibility */}
              <button className="px-3 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors duration-200 text-sm sm:text-base min-h-12 whitespace-nowrap">
                Sign Up  For Free
              </button>
              <button className="px-3 py-3 border-2 border-blue-600 text-blue-600 font-semibold rounded-lg hover:bg-blue-50 transition-colors duration-200 text-sm sm:text-base min-h-12 whitespace-nowrap">
                Learn More
              </button>
            </div>
          </div>
